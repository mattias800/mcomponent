...
test("Set view with special characters", function () {
    ...
    equal(c._assertInterpretAndCompile(), v);
...
test("Interpretation context", function () {
...
test("lookup from models not on top of stack", function () {
    ...
    equal(c._assertInterpretAndCompile(), "ok2test1test2", "Should contain 'ok2test1test2', all lookups should be ok.");
    ...
    equal(c._assertInterpretAndCompile(), "ok2test1test2", "Pushing model that is not on top of stack should work. Should contain 'ok2test1test2', all lookups should be ok.");
...
test("if tag", function () {
    ...
    equal(c._assertInterpretAndCompile(), "heyhey", "Should contain 'heyhey', have no tags.");
    ...
    equal(c._assertInterpretAndCompile(), "baibai", "Should contain 'baibai', since if case is true.");
    ...
    equal(c._assertInterpretAndCompile(), "12", "Should contain '12', since both if cases are true.");
    ...
    equal(c._assertInterpretAndCompile(), "1", "Should contain '1', since only first if case is true.");
    ...
    equal(c._assertInterpretAndCompile(), "", "Should contain '', since only second if case is true.");
    ...
    equal(c._assertInterpretAndCompile(), "12345", "Should contain '12345'.");
    ...
    equal(c._assertInterpretAndCompile(), "1245", "Should contain '1245'.");
    ...
    equal(c._assertInterpretAndCompile(), "15", "Should contain '15'.");
    ...
    equal(c._assertInterpretAndCompile(), "12345", "Should contain '12345', then if with this.model works.");
    ...
    equal(c._assertInterpretAndCompile(), "1245", "Should contain '1245', then if with this.model works.");
    ...
    equal(c._assertInterpretAndCompile(), "12345", "Should contain '12345', then if with model (without this.model) works.");
    ...
    equal(c._assertInterpretAndCompile(), "1245", "Should contain '1245', then if with model (without this.model) works.");

    ok(c = $().mcomponent({model:{name:"mattias"}, viewHtml:"1{% if (this.model.name == 'mattias') %}2{% endif %}3"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "123", "If with 'this.model.name'.");

    ok(c = $().mcomponent({model:{name:"mattias"}, viewHtml:"1{% if (model.name == 'mattias') %}2{% endif %}3"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "123", "Same again, but with 'model.name' instead of 'this.model.name'.");
...
test("else, elseif tags", function () {
    ...
    equal(c._getTree().length, 1, "Root contains only one element.");
    equal(c._assertInterpretAndCompile(), "ok", "Should contain 'ok', since if case is true.");
    ...
    equal(c._getTree().length, 1, "Root contains only one element.");
    equal(c._assertInterpretAndCompile(), "innerfail", "Should contain 'innerfail', since if case is true.");
...
test("API", function () {
    ...
    equal(c._assertInterpretAndCompile(), "funkar", "api.lookup() should result in 'funkar'.");
    ...
    ok(c = $().mcomponent({model:model, viewHtml:view}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "yes", "api.lookup() should find 'yes'.");
...
test("large view test", function () {
    ...
    equal(c._getTree().length, 1, "Root contains only one element.");
    ok(result = c._assertInterpretAndCompile(), "Rendering of large view should be OK!");
    ...
    ok(result = c._assertInterpretAndCompile(), "niter over user only");
    ...
    ok(result = c._assertInterpretAndCompile(), "location and city only");
    ...
    ok(result = c._assertInterpretAndCompile(), "location and country only!");
    ...
    ok(result = c._assertInterpretAndCompile(), "niter with location and both city and country without output and if cases and push!");
    ...
    ok(result = c._assertInterpretAndCompile(), "niter with location and both city and country without output and if cases and push country!");
    ...
    ok(result = c._assertInterpretAndCompile(), "niter with location and both city and country without output and if cases and push city!");
    ...
    ok(result = c._assertInterpretAndCompile(), "niter with location and both city and country without output and if cases!");
    ...
    ok(result = c._assertInterpretAndCompile(), "niter with location and both city and country without output!");
    ...
    ok(result = c._assertInterpretAndCompile(), "niter with location and both city and country!");
    ...
    ok(result = c._assertInterpretAndCompile(), "full view!");
...
test("showing other things than model properties", function () {
    ...
    equal(c._assertInterpretAndCompile(), "mattias", "Should contain 'mattias' after API lookup.");

    ok(c = $().mcomponent({model:{name:"mattias"}, viewHtml:"{% show Math.floor(1.5); %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "1", "Should contain '1' after Math.floor.");
...
test("show tag", function () {
    ...
    equal(c._assertInterpretAndCompile(), "mattias", "Should contain 'mattias'.");

    ok(c = $().mcomponent({model:{user:{name:"marcus"}}, viewHtml:"{% show user.name %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "marcus", "Should contain 'marcus'.");
    ...
    equal(c._assertInterpretAndCompile(), "www.google.com", "Should contain 'www.google.com' using lookup with runFunction().");

    ok(c = $().mcomponent({model:{ list:[
        {url:"www.google.com" },
        {url:"www.facebook.com"}
    ]}, viewHtml:"{% model.list[1].url %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "www.facebook.com", "Should contain 'www.facebook.com' using lookup with runFunction().");

    ok(c = $().mcomponent({model:{ list:[
        {url:"www.google.com" },
        {url:"www.facebook.com"}
    ]}, viewHtml:"{% showjs model.list[0].url %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "www.google.com", "Should contain 'www.google.com' using showjs.");
...
test("push tag", function () {
    ...
    equal(c._assertInterpretAndCompile(), "yeah", "Should contain 'yeah' instead.");
    ...
    equal(c._assertInterpretAndCompile(), "", "Pushing two level property. Should contain nothing since model stack lookup should fail.");
    ...
    equal(c._assertInterpretAndCompile(), "yeah", "Pushing two level property. Should contain 'yeah'.");

    ok(c = $().mcomponent({model:{db:{user:{name:"marcus"}, test:"yeah"}}, viewHtml:"{% push db.user %}{% show name %}{% endpush %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "marcus", "Pushing two level property. Should contain 'marcus'.");
...
test("iter tag", function () {
    ...
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohan", "Should contain 'mattiasmarcusjohan'.");
    ...
    equal(c._assertInterpretAndCompile(), "012", "Iterator context should give us '012' in the result.");

    ok(c = $().mcomponent({
        model:{
            list:["mattias", "marcus", "johan"]
        }, viewHtml:"{% iter list %}{% show context.index %}{% enditer %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "012", "Iterator context should give us '012' in the result when using show and context.");

    ok(c = $().mcomponent({
        model:{
            list:["mattias", "marcus", "johan"]
        }, viewHtml:"{% iter list %}{% if (context.index == 1) %}{% show context.index %}{% endif %}{% enditer %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "1", "If-case with context in condition. Iterator context should give us '1' in the result when using show and context.");

    ok(c = $().mcomponent({
        model:{
            list:["mattias", "marcus", "johan"]
        }, viewHtml:"{% iter list %}{% context.index %}{% enditer %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "012", "Iterator context should give us '012' in the result when using no tag, and context.");

    ok(c = $().mcomponent({
        model:{
            list:["mattias", "marcus", "johan"]
        }, viewHtml:"{% iter list %}{% context size %}{% enditer %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "333", "Iterator context should give us '333' in the result.");
    ...
    equal(c._assertInterpretAndCompile(), "evenoddeven", "Iterator context parity should give us 'evenoddeven' in the result.");
...
test("niter tag, using show more", function () {
    ...
    equal(c._assertInterpretAndCompile(), "mattias", "Should first element only.");
    ...
    i.showMoreItems();
    equal(c._assertInterpretAndCompile(), "mattiasmarcus", "Should contain one more element.");
    equal(a, 3, "a should be 3 first.");
    i.showMoreItems();
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohan", "Should contain all three elements.");
    equal(a, 5, "a should now be 5 since callback changed the value.");
    i.showMoreItems();
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohan", "Should contain all three elements again.");
    ...
    equal(a, 3, "a should be 3 first.");
    i.showAllItems();
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohan", "Should show all elements.");
    equal(a, 5, "a should now be 5 since callback changed the value.");
...
test("niter tag, using pages", function () {
    ...
    equal(c._assertInterpretAndCompile(), "mattiasmarcus", "Should show first two element.");
    ok(i = c.getIterator("userListIter"));
    equal(i.getPageCount(), 3);
    i.showPrevPage();
    equal(c._assertInterpretAndCompile(), "mattiasmarcus", "Should show first two again since it is first page.");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "johanbutters", "Should show second two elements.");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "stan", "Should show second two elements.");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "stan", "Next page should be same, since it is last page.");
    i.showPrevPage();
    equal(c._assertInterpretAndCompile(), "johanbutters", "And now we go back to previous page.");
    ...
    ok(c = $().mcomponent({
        ...
        viewHtml:"{% niter userListIter list %}{% show %}{% endniter %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohan", "Should first element only.");
    ok(i = c.getIterator("userListIter"));
    equal(i.getPageCount(), 2);
    i.showPrevPage();
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohan", "Should show first two again since it is first page.");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "buttersstan", "Should show page 2.");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "buttersstan", "Same again.");
    i.showPrevPage();
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohan", "And now we go back to previous page.");
    ...
    i.showPrevPage();
    equal(c._assertInterpretAndCompile(), "mattias");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "marcus");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "johan");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "butters");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "stan");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "stan", "Next page should be same, since it is last page.");
    i.showPrevPage();
    equal(c._assertInterpretAndCompile(), "butters", "And now we go back to previous page.");
    ...
    ok(c = $().mcomponent({
        ...
        viewHtml:"{% niter userListIter list %}{% show %}{% endniter %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohanbuttersstan", "Should first element only.");
    ok(i = c.getIterator("userListIter"));
    equal(i.getPageCount(), 1);
    i.showPrevPage();
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohanbuttersstan");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohanbuttersstan");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohanbuttersstan");
    ...
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohanbuttersstan");
    i.showPrevPage();
    equal(c._assertInterpretAndCompile(), "mattiasmarcusjohanbuttersstan", "And now we go back to previous page.");
    ...
    ok(c = $().mcomponent({
        ...
        viewHtml:"{% niter userListIter list %}{% show %}{% endniter %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "", "Should first element only.");
    ok(i = c.getIterator("userListIter"));
    equal(i.getPageCount(), 0);
    i.showPrevPage();
    equal(c._assertInterpretAndCompile(), "");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "");
    i.showNextPage();
    equal(c._assertInterpretAndCompile(), "");
...
test("js and showjs tags", function () {
    ...
    equal(c._assertInterpretAndCompile(), "mattias", "'showjs' tag should work.");

    ok(c = $().mcomponent({viewHtml:"{% showjs Math.sqrt(9); %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "3", "Should not throw error.");

    ok(c = $().mcomponent({model:{name:"mattias yo"}, viewHtml:"{% showjs model.name; %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "mattias yo", "Should be able to use model.");

    ok(c = $().mcomponent({viewHtml:"{% js Math.sqrt(5); %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "", "Should not throw error.");
...
test("globals", function () {
    ...
    equal(c._assertInterpretAndCompile(), "", "Setting globals should work.");
    ...
    equal(c._assertInterpretAndCompile(), "mattias yeah", "Setting and showing globals should work.");
    equal(c.getGlobals().testing, "mattias yeah", "Setting globals should work.");

    ok(c = $().mcomponent({viewHtml:"{% js globals.testing = true %}{% if (globals.testing) %}ohyeah{% endif %}"}), "Construction OK!");
    equal(c._assertInterpretAndCompile(), "ohyeah", "Setting and using globals in if condition should work.");
    ...
    equal(c._assertInterpretAndCompile(), "mattias yeah", "setglobal tag and showing globals should work.");
    equal(c.getGlobals().testing, "mattias yeah", "Setting globals should work.");
...
test("Clipboard", function () {
    ...
    equal(c._assertInterpretAndCompile(), "80", "Predefined clipboard, should paste and result in '80'.");
    ...
    equal(c._assertInterpretAndCompile(), "80", "Predefined clipboard, clip in clip, should paste and result in '80'.");
    ...
    equal(c._assertInterpretAndCompile(), "85", "Copying from inside view, copying should not remove the original.");
...
var doMcomponentProfiling = function () {
    ...
    var tinterpret = new Timer("interpret");
    ...
    tinterpret.start();
    for (i = 0; i < times; i++) c._assertInterpret();
    tinterpret.stop();
    ...
    console.log(tinterpret.toString());
